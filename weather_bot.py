    ...
    def generate_dashboard(self, data):
        ...
        <head>
            ...
            <style>
                ...
                .card {{ background: #111; border-radius: 24px; padding: 30px; margin-bottom: 25px; border: 1px solid #222; }}
                .main-temp {{ font-size: 80px; color: {brand_green}; font-weight: 900; text-align: center; }}
                .prob-bar {{ height: 12px; background: #222; border-radius: 6px; margin: 10px 0; overflow: hidden; }}
        ...
        <body>
            <div class="container">
                ...
                <p style="text-align:center; color:#888;">London | April 17, 2026</p>
                <div class="card">
                ...
                <div class="card" style="background:{brand_green}; color:#000;">
                    ...
                    <p>מחיר ל-{data['target']}: <strong>{price_val:.2f}¢</strong> | ROI: <strong>{roi:.1f}%</strong></p>
                </div>
                <p style="text-align:center; color:#444; font-size:12px;">עודכן ב: {data['time']}</p>
            </div>
        </body>
        </html>
        """
