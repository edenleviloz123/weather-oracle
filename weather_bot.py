...
def run_bot():
    ...
    <style>
        ...
        .footer {{ text-align: center; font-size: 11px; color: #444; margin-top: 30px; border-top: 1px solid #222; padding-top: 15px; }}
    </style></head>
    <body>
        ...
        <div class="card">
            ...
            <div class="desc-box">הטמפרטורה המשוקללת המחושבת מ-5 מודלים מובילים. זהו "ערך האמת" אליו ה-AI שואף.</div>
        </div>

        <div class="card">
            <div class="title">⚖️ ניתוח ארביטראז' ו-Edge</div>
            <div class="signal">
                <div style="font-size:10px; color:#777;">OPPORTUNITY</div>
        ...
        <div class="card">
            <div class="title">🌡️ פירוט מודלים מזג אוויר</div>
